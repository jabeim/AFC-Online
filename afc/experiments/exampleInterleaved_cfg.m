...
%{ 
note tht the exppars are organized
   [A A A A B B B B]'
   [C D C D C D C D]'
   [E E F F E E F F]'

so that they are each a unique condition. 

In my case, I will want to interleave, I believe... Actually I want to
measure two thresholds at once. 

Also hey note the transposition. These are organized as column vectors. 


I don't think I'm going to be able to do this easily. I think I'm going to
need to either:

   - gauge the thresholds seperately, and just lie to the participant about
    when they are "correct" and when they are not "correct"
   
   - Look into some Deep Shit about how the thresholds are calculated and
   saved. Then, do it myself. 

Honestly I think I'm going to end up having to do the latter. 

Interleaving is not what I want to do. Although actually it seems like it
*was* what I wanted to do when Jackson told me to. 
