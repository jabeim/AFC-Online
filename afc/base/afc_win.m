...
def.afc_win = figure('BusyAction','cancel','KeyPressFcn',...			% create modal dialog window
...
set(def.afc_win,'position',def.winFigurePosition);
...
case 1
	...
	b = uicontrol('Parent',def.afc_win, ...										% create start button
		'Units','normalized', ...
   ...
   if ( (def.mouse == 0) )
	...
	b = uicontrol('Parent',def.afc_win, ...										% create end button
		'Units','normalized', ...
		'FontUnits','normalized', ...
		'BusyAction','cancel', ...
...
case 0
b = uicontrol('Parent',def.afc_win, ...										% create message display
	'Units','normalized', ...
	'FontUnits','normalized', ...
   ...
   yShiftButtons = 0; 
case 1
   t1 = uicontrol('Parent',def.afc_win, ...										% create message display
	'Units','normalized', ...
	'FontUnits','normalized', ...
   'BackgroundColor',[0.9 0.9 0.9], ...
  	'FontSize',0.4, ...
   ...
   'Tag','afc_t1');
	...
	t2 = uicontrol('Parent',def.afc_win, ...										% create message display
	'Units','normalized', ...
	'FontUnits','normalized', ...
   'BackgroundColor',[0.9 0.9 0.9], ...
  	'FontSize',0.4, ...
